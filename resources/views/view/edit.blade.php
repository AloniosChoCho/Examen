                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card">
                                <div class="card-body">
                                  ...
                                  @endif
                                  <form action="{{ route('view.update', ['view' => $view->id]) }}" enctype="multipart/form-data" class="row" method="POST">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                      ...
                                      <textarea class="form-control textarea" name="descripcion" id="descripcion" row="3">{{$view->descripcion}}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                      <img src="{{ asset('storage/view/'.$view->imagen) }}"
                                                  onclick="openModalImage('{{$view->imagen}}')" style="block-size: 150px;border-radius: 10px;"
                                                  alt="Imagen de {{ $view->imagen }}">
                                    </div>

                                    <div class="col-sm-12 mt-3">
                                      <a href="{{ route('view.index') }}" class="btn btn-sm btn-danger">Cancelar</a>
