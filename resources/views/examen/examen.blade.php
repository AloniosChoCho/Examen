...
<style>
  ...
  <head>
      ...
      <link rel="stylesheet" href="{{asset('frontend/assets/css/estilos.css')}}">
      <link href="{{asset('frontend/assets/css/css2.css')}}" rel="stylesheet">
        ...
        <div class="d-flex">
          <div class="navbar-brand-box">
            <a class="logo logo-dark">
              <span class="logo-lg">
                <img style="width: 200px;height: 50px;" src="{{asset('frontend/assets/images/Vector.svg')}}" alt="" height="20">
              </span>
            </a>
          </div>
          <button type="button" class="btn px-3 font-size-24 header-item waves-effect" id="vertical-menu-btn">
            <img src="{{asset('frontend/assets/images/rayas.svg')}}" alt="">
          </button>
        </div>
          <span class="logo-lg">
            <img src="{{asset('frontend/assets/images/Vector.svg')}}" alt="" height="24">
          </span>
        </div>
    </div>
  </header>
          <div class="vertical-menu">
            <span class="logo-lg">
              <div class="text-center">
                <img style="width: 200px; height: 50px;" src="{{asset('frontend/assets/images/icons/Peru (PE).svg')}}">Peru <img src="{{asset('frontend/assets/images/icons/flecha.svg')}}" alt="">
              </div>
            </span>
                <div id="sidebar-menu">
                    <div>
                      <span>
                        <img style="bottom: 20%; height: 203px; width: 245px;" src="{{asset('frontend/assets/images/avatar.svg')}}" alt="" height="20">
                        <h5 class="text-center" style="color: #ffffff;">Alonios</h5>
                        <hr size="4px"/>
                        <a href="{{route("netflix.edit",['netflix'])}}"><h5  style="color: #5c6772; text-align: end;"> Mi perfil <img style="color: #ffffff;"
                                                            {{-- => $netflix->id  --}}
                            src="{{asset('frontend/assets/images/icons/Edit.svg')}}" alt=""></h5></a>
                      </span>
                    </div>
                    <ul class="metismenu list-unstyled" id="side-menu">
                      ...
                      <li>
                          <a href="javascript: void(0);">
                              <img src="{{asset('frontend/assets/images/icons/cate.svg')}}" alt="">
        ...
        <div class="main-content">
            <div class="page-content">
              <div class="container-fluid">
                    ...
                    <div class="pelicula-principal">
                      <div class="contenedor">
                        <div class=" mini-stat position-relative">
                          <img style="bottom: 40%; height: 292px; width: 384px;" src="{{asset('frontend/assets/images/image1.svg')}}" alt="">
                        </div>
                        <div class="c">
                        ...
                        <button role="button" class="boton"><img src="{{asset('frontend/assets/images/icons/pLay.svg')}}"></img></i></button>
                        <button role="button" class="boton"><img src="{{asset('frontend/assets/images/icons/hear.svg')}}"></img></i></button>
                        <button role="button" class="boton"><img src="{{asset('frontend/assets/images/icons/clarity_clock-outline-alerted.svg')}}"></img></i></button>
                        <button role="button" class="boton"><img src="{{asset('frontend/assets/images/icons/list-plus.svg')}}"></img></i></button>
                      </div>
                    </div>
                </div>
                  ...
                  <div class="contenedor-principal">
                    ...
                    <div class="contenedor-carousel">
                      <div class="carousel">
                        ...
                        <div class="pelicula">
                          <a href="#"><img src="{{asset('storage/admin/'.$admin->imagen) }}" alt=""></a>
                          <h5>{{$admin->title}}</h5>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="contenedor-principal">
                      ...
                      <div class="contenedor-carousel">
                        <div class="carousel">
                          ...
                          <div class="pelicula">
                            <a href="#"><img src="{{asset('storage/view/'.$view->imagen) }}" alt=""></a>
                            <h5>{{$view->title}}</h5>
                          </div>
                          @endforeach
                      </div>
                ...
                <div class="noticia">
                  <img style="bottom: 40%; height: 292px; width: 384px;" class="izquierda" src="{{asset('frontend/assets/images/niños.svg')}}">
                    <aside>
                      <h4 style="color: #ffffff; font-size: 30px;" class="titulo">Crea perfiles para niños.</h4>
                        <div style="color: #ffffff; font-size: 15px;">
                            <p class="descripcion">
                            Los niños vivirán aventuras con sus personajes
  ...
  <div class="rightbar-ofrontend/verlay"></div>
  ...
  <script src="{{asset('frontend/libs/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
  <script src="{{asset('frontend/libs/ion-rangeslider/js/ion.rangeSlider.min.js')}}"></script>
  <script src="{{asset('frontend/js/pages/range-sliders.init.js')}}"></script>
